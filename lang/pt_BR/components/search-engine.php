...
return [
    ...
    'web' => [
        'preview_title' => 'Site demo',
        'page_title' => 'Pesquisa',
        'kicker' => 'Busca web',
        'page_description' => 'Exemplo público consumindo o escopo web do Search Engine com posts e produtos fake publicados.',
        'placeholder' => 'Buscar produtos e posts...',
        'submit' => 'Pesquisar',
        'search_button' => 'Abrir pesquisa',
        ...
        'open_result' => 'Acessar',
        'suggestions_summary' => 'Sugestões para começar, geradas a partir dos registros publicados da demo.',
        'results_summary' => ':count resultados para <strong>":term"</strong>.',
        'nav' => [
            'home' => 'Início',
            'search' => 'Pesquisa',
            'docs' => 'Docs',
