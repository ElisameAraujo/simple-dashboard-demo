...
return [
    ...
    'web' => [
        'preview_title' => 'Demo site',
        'page_title' => 'Search',
        'kicker' => 'Web search',
        'page_description' => 'Public example consuming the Search Engine web scope with published fake posts and products.',
        ...
        'open_result' => 'Open',
        'suggestions_summary' => 'Suggestions to start with, generated from the published demo records.',
        'results_summary' => ':count results for <strong>":term"</strong>.',
        'nav' => [
            'home' => 'Home',
            'search' => 'Search',
            'docs' => 'Docs',
