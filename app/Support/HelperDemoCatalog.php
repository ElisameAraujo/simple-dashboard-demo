...
class HelperDemoCatalog
{
    ...
    private static function stringOutputFor(string $method): string
    {
        ...
        return match ($method) {
            ...
            'stripHTML', 'cleanText', 'normalizeWhitespace', 'removeLineBreaks', 'sanitize' => $locale === 'pt_BR' ? 'Olá mundo' : 'Hello world',
            'removeAccents' => 'acao',
            'convertSpecialCharacters' => 'Rock and Roll',
            'slug' => $locale === 'pt_BR' ? 'ola-mundo' : 'hello-world',
            'excerpt' => $locale === 'pt_BR' ? 'Olá...' : 'Hello...',
            'capitalizeNames', 'normalizeNames' => $locale === 'pt_BR' ? 'Maria da Silva' : 'John Doe',
            'firstName' => $locale === 'pt_BR' ? 'Maria' : 'John',
            'initials' => $locale === 'pt_BR' ? 'MS' : 'JD',
            'onlyNumbers' => '61999990000',
            'emptyFallback' => '—',
            'booleanLabel' => $locale === 'pt_BR' ? 'Sim' : 'Yes',
    ...
    private static function genericOutputFor(string $method): string
    {
        return match ($method) {
            ...
            'daysDifference', 'countWords', 'countCharacters', 'readingTime', 'allUnreadNotificationsCount', 'unreadNotificationsByTypeCount' => '3',
            'userId' => '1',
